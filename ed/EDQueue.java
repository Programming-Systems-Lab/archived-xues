...
public class EDQueue {
   ...
   */
  private static String TS_STR = EDConst.TIME_ATT_NAME;
  ...
  private static void simpleQueueTest(){
    ...
    try{
      ...
      n = new Notification();
      n.putAttribute(EDConst.TIME_ATT_NAME,System.currentTimeMillis()-1000);
      q.enqueue(n);
      ...
      n = new Notification();
      n.putAttribute(EDConst.TIME_ATT_NAME,System.currentTimeMillis()-3000);
      q.enqueue(n);
