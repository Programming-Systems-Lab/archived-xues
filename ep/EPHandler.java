...
/**
 * Handler class to perform actions on Notifications.  Works based on
 * the configuration specified in EPHandler.cfg.
 *
 * Copyright (c) 2001: The Trustees of Columbia University
 * in the City of New York. All Rights Reserved.
 * 
 * @author: Janak J Parekh <janak@cs.columbia.edu> and Amna Qaiser
 * <aq41@cs.columbia.edu>
 * @version $Revision$
 */
